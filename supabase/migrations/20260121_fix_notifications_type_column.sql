-- Fix notifications INSERT statements to match actual schema
-- Schema: id, user_id, org_id, title, message, link, read_at, created_at
-- Does NOT have: type, metadata columns

-- Recreate functions without type and metadata columns

-- ==================================================
-- Helper function: is_org_owner
-- ==================================================
-- Fix to use member_status (text) instead of status (enum)
-- Allow PENDING member status and ONBOARDING/SUBMITTED_FOR_REVIEW org status for V2 pre-onboarding
