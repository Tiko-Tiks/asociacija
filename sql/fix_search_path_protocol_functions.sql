-- ==================================================
-- MIGRATION: Fix search_path for SECURITY DEFINER protocol functions
-- ==================================================
-- Date: 2024
...
--
-- Functions fixed:
-- 1. build_meeting_protocol_snapshot
-- 2. preview_meeting_protocol
-- 3. finalize_meeting_protocol
-- 4. get_meeting_protocol
-- ==================================================
...
-- 3) finalize_meeting_protocol
-- ==================================================
-- NOTE: Drop existing function first to handle return type changes
-- The function might have different return types in different versions
-- (protocol_version INT vs version INT), so we drop both variants
-- ==================================================

-- Drop both possible variants (with different return types)
DROP FUNCTION IF EXISTS public.finalize_meeting_protocol(UUID) CASCADE;
...
-- MIGRATION COMPLETE
-- ==================================================
-- All 4 protocol functions now have SET search_path = public, pg_temp
