-- ==================================================
-- FIX: finalize_meeting_protocol - naudoti md5() vietoj digest()
-- ==================================================
-- Problema: pgcrypto.digest() neveikia Supabase (extension įjungtas, bet funkcijos nerastos)
-- Sprendimas: Naudoti md5() kuris yra PostgreSQL built-in, nereikalauja extension
-- ==================================================
-- Date: 2026-01-11
-- Issue: pgcrypto extension įjungtas, bet digest() funkcija nerasta
-- Governance: v19.0 Schema Freeze compliant (funkcijų logikos pakeitimas leistinas)
-- NOTE: md5() pakeičia SHA256 į MD5 (trumpesnis hash, bet vis dar užtikrina integrumą)
-- ==================================================

-- Pakeisti funkcijoje hash skaičiavimą iš digest() į md5()
-- md5() yra PostgreSQL built-in funkcija, nereikalauja extension

-- Atnaujinti funkcijos hash skaičiavimo dalį
...
BEGIN
  ...
  -- =====================================================
  -- FIX: Naudoti md5() vietoj digest() 
  -- md5() yra PostgreSQL built-in, nereikalauja pgcrypto extension
  -- MD5 yra pakankamas snapshot integrumui (nors trumpesnis nei SHA256)
  -- =====================================================
  v_hash := md5(v_snapshot::TEXT);
  
  -- Get next version (fix: explicitly specify table.version to avoid ambiguity)
...
COMMENT ON FUNCTION public.finalize_meeting_protocol IS 'Finalizuoti protokolą (tik OWNER/BOARD, reikalauja visų GA votes CLOSED). Fixed: uses md5() instead of digest() - compatible with Supabase pgcrypto extension issues.';
