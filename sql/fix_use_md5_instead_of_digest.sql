-- ==================================================
-- FIX: Pakeisti digest() į md5() (built-in funkcija)
-- ==================================================
-- Problema: digest() reikalauja pgcrypto plėtinio
-- Sprendimas: Naudoti md5() kuris yra PostgreSQL built-in
-- ==================================================

-- Pirma ištrinti seną funkciją (return type pasikeitė)
...
BEGIN
  ...
  -- md5() yra PostgreSQL built-in, nereikalauja pgcrypto
  -- =====================================================
...
COMMENT ON FUNCTION public.finalize_meeting_protocol IS 'Finalizuoti protokolą (naudoja md5 vietoj digest - FIX v18.8.7)';
